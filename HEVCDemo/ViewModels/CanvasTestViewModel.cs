...
namespace HEVCDemo.ViewModels
{
    public class CanvasTestViewModel : BindableBase
    {
        ...
        {
            //this.Rectangles = new Obser<Rectangle>();
            //this.Rectangles.Add(new Rectangle() { X = 10, Y = 10, Height = 20, Width = 20 });
        }

        private DelegateCommand backwardClick;
        public DelegateCommand BackwardClick =>
            backwardClick ?? (backwardClick = new DelegateCommand(ExecuteBackwardClick));

        private void ExecuteBackwardClick()
        {
            //this.Rectangles.Add(new Rectangle() { X = 100, Y = 100, Height = 200, Width = 200 });
            ReadFile();
        }
